...
import { updateShoppingCart, deleteShoppingCartItems } from "../../features/shoppingCart/shoppingCartSlice";
...
export const IncreaseDecreaseAmountButton: React.FC<IIncreaseDecreaseAmountButtonProps> = ({item}) => {
                      ...
                      if (item.amout < 6) {
                        dispatch(
                          updateShoppingCart({
                            ...
                            amout: item.amout + 1,
                            totalPrice:
                              (item.amout + 1) * item.product.fields.priceWithDiscount,
                          })
                        );
                      }
                    }}
