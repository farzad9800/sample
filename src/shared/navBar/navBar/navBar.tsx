import { Grid, Box, Tooltip, IconButton, Badge, Menu, MenuItem, Typography, List, ListItem, Divider, Button, InputAdornment, TextField } from '@mui/material';
...
const NavBar = () => {
  ...
  return (
    <Grid container sx={{px:{xs:"10px", md:"40px"}, bgcolor:"#e1e1e1", boxShadow:"1px 1px gray"}} py="30px">
    <NavBarLogo />
  ...
  />
          ...
          <Grid container xs={6} md={4} sx={{ justifyContent: {xs:"end",md:"center"}, pr:{xs:0, md:"70px"}}}>
            <Grid>
              <Box>
              ...
              >
                <MenuItem sx={{ bgcolor: "#f9f8f8", mx: "6px", borderRadius: "10px" }}>
                  <Grid container xs={6}>
                    <Link
                      to="/shoppingcart"
        ...
        <ShoppingCartMenuItemDrop  item={cartItem} />
                ...
                <MenuItem>
                  <Grid container xs={6}>
                    <Typography>5555.555</Typography>
                    <Typography  mr="5px">تومان</Typography>
                  </Grid>
                  <Grid xs={6} sx={{ textAlign:"center" }} >
                    <Button variant="contained" size="small" sx={{bgcolor:"yellow", color:"black", width:"80%"}}>
                      پرداخت
                    </Button>
                  </Grid>
                </MenuItem>
